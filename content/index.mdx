...
| Endpoint                 | Type | Parameters | Required | Default | Response |
| ------------------------ | ---- | ---------- | -------- | ------- | -------- |
...
| Endpoint                | Type | Parameters       | Required | Default | Response |
| ----------------------- | ---- | ---------------- | -------- | ------- | -------- |
| `/api/get-twitter-user` | POST | username: string | true     | n/a     | JSON     |
...
| Endpoint                   | Type | Parameters          | Required | Default | Response |
| -------------------------- | ---- | ------------------- | -------- | ------- | -------- |
| `/api/make-stripe-payment` | POST | product: string     | true     | n/a     | JSON     |
...
| Endpoint               | Type | Parameters       | Required | Default | Response |
| ---------------------- | ---- | ---------------- | -------- | ------- | -------- |
| `/api/get-github-user` | POST | username: string | true     | n/a     | JSON     |
...
| Endpoint               | Type | Parameters    | Required | Default | Response |
| ---------------------- | ---- | ------------- | -------- | ------- | -------- |
| `/api/get-github-repo` | POST | owner: string | true     | n/a     | JSON     |
...
| Endpoint                      | Type | Parameters       | Required | Default | Response |
| ----------------------------- | ---- | ---------------- | -------- | ------- | -------- |
| `/api/get-github-user-events` | POST | username: string | true     | n/a     | JSON     |
...
| Endpoint                      | Type | Parameters      | Required | Default | Response |
| ----------------------------- | ---- | --------------- | -------- | ------- | -------- |
| `/api/get-github-repo-events` | POST | owner: string   | true     | n/a     | JSON     |
| -                             | -    | repo: string    | true     | n/a     | -        |
| -                             | -    | results: number | false    | 5       | -        |
