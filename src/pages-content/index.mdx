...
<ExpandableContent  startExpanded={true}trigger={ (isExpanded) => <EndpointMessage type="POST" endpoint="/api/get-twitter-user" icon="lock" isExpanded={isExpanded} isExpanded={isExpanded} />}>
...
<ExpandableContent trigger={(isExpanded) => <EndpointMessage type="POST" endpoint="/api/make-stripe-payment" icon="lock" isExpanded={isExpanded} />}>
...
<ExpandableContent trigger={(isExpanded) => <EndpointMessage type="POST" endpoint="/api/get-github-user" icon="lock" isExpanded={isExpanded} />}>
...
<ExpandableContent trigger={(isExpanded) => <EndpointMessage type="POST" endpoint="/api/get-github-events" icon="lock" isExpanded={isExpanded} />
}>
