...
This endpoint uses the Octokit `octokit.request('GET /user', { name: username })` method under the hood to return information about a GitHub username.
...
| Endpoint               | Type | Parameters       | Allowed Domains | Response |
| ---------------------- | ---- | ---------------- | --------------- | -------- |
| `/api/get-github-user` | POST | username: string | n/a             | JSON     |
