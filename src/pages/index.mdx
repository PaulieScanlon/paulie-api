...
This endpoint uses the Octokit `octokit.request('GET /users/{username}/events', { username: username, })` method under the hood to return events for a GitHub username.
